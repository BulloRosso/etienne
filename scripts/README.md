...
3. Agents that help humans decide — Part 3: Requirements → Specification — implemented by [`seed-requirements-hv/`](seed-requirements-hv/). *(LinkedIn URL to be added.)*
