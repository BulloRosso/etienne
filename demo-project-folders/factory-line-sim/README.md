...
|---|---|---|---|
| 2026-05-15 − 4 | CNC-5AX | Chip-bin overflow → conveyor jam → tool damage | 4 dimensional + 2 edge defects on PO-1005 |
| 2026-05-15 − 2 | CNC-5AX | Coolant temperature elevated for 3 h (degraded state) | 6 surface_finish + 3 surface_staining defects on PO-1003 |
